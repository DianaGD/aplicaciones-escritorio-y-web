...
public class ConstantesSQL {
	...
	public static final String SQL_SELECCION_PRODUCTOS = "SELECT tabla_productos.id, tabla_productos.nombre, tabla_productos.precio, tabla_categorias.nombre as nombre_categoria from tabla_productos, tabla_categorias where tabla_productos.id_categoria = tabla_categorias.id and tabla_productos.nombre like ? order by tabla_productos.id desc limit ?,?";
