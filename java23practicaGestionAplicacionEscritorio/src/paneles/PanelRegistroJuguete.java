...
public class PanelRegistroJuguete extends JPanel implements ActionListener {
	...
	// defino los items del ComboBox en un array de String
	//String[] categoriaItems = new String[] {"Cartas", "Educativo", "Estrategia", "Manualidades", "Mesa", "Puzzle"};
	//defino el comboBox 
	//JComboBox<String> comboCategoria = new JComboBox<String>(categoriaItems);
